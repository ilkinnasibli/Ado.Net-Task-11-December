...
string query = @"Data Source =Victus;Initial Catalog=BB101;Trusted_Connection=True;";
...
CreateEmployee("osman ", "osmanov", 900);
...
//4) SearchEmployeeByName() - employee - leri adina gore axtaracaq
...
List<Employee> SearchEmployeeByName()
{
    ...
    {
        connection.Open();
        string sqlCommand = "select * from Employee where Name='Ilkin' ";
...
CreateEmployee("Murad", "Osmanov", 500);
